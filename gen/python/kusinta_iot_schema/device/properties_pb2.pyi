...
class ContactSensorProperties(_message.Message):
    ...
    state_value: bool
    def __init__(self, state_value: bool = ...) -> None: ...
...
class DoorLockProperties(_message.Message):
    ...
    door_state: int
    operating_mode: int
    def __init__(self, lock_state: _Optional[int] = ..., lock_type: _Optional[int] = ..., actuator_enabled: bool = ..., door_state: _Optional[int] = ..., operating_mode: _Optional[int] = ...) -> None: ...
...
class OnOffLightProperties(_message.Message):
    ...
    off_wait_time: int
    start_up_on_off: int
    def __init__(self, on_off: bool = ..., global_scene_control: bool = ..., on_time: _Optional[int] = ..., off_wait_time: _Optional[int] = ..., start_up_on_off: _Optional[int] = ...) -> None: ...
...
class DimmableLightProperties(_message.Message):
    ...
    remaining_time: int
    def __init__(self, on_off: bool = ..., current_level: _Optional[int] = ..., min_level: _Optional[int] = ..., max_level: _Optional[int] = ..., on_level: _Optional[int] = ..., start_up_current_level: _Optional[int] = ..., remaining_time: _Optional[int] = ...) -> None: ...
...
class ColorTemperatureLightProperties(_message.Message):
    ...
    color_mode: int
    def __init__(self, on_off: bool = ..., current_level: _Optional[int] = ..., color_temperature_mireds: _Optional[int] = ..., color_temp_physical_min_mireds: _Optional[int] = ..., color_temp_physical_max_mireds: _Optional[int] = ..., startup_color_temperature_mireds: _Optional[int] = ..., color_mode: _Optional[int] = ...) -> None: ...
