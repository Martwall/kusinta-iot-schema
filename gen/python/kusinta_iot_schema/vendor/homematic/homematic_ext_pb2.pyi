...
class HmThermostatProps(_message.Message):
    ...
    def __init__(self, boost_mode: bool = ..., boost_time_period: _Optional[float] = ..., control_mode: _Optional[int] = ..., frost_protection: bool = ..., current_profile_period: _Optional[float] = ...) -> None: ...
...
class HmWindowActuatorProps(_message.Message):
    ...
    def __init__(self, drive_state: _Optional[int] = ..., error_efuse: bool = ..., error_motor_coils_temp: bool = ...) -> None: ...
...
class HmDoorSensorProps(_message.Message):
    ...
    sabotage: bool
    low_battery: bool
    def __init__(self, sabotage: bool = ..., low_battery: bool = ...) -> None: ...
...
class HmSmokeDetectorProps(_message.Message):
    ...
    low_battery: bool
    def __init__(self, alarm_triggered: bool = ..., low_battery: bool = ...) -> None: ...
