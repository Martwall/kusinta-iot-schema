...
class EndpointDescriptor(_message.Message):
    __slots__ = ("endpoint_id", "matter_device_type_id")
    ENDPOINT_ID_FIELD_NUMBER: _ClassVar[int]
    MATTER_DEVICE_TYPE_ID_FIELD_NUMBER: _ClassVar[int]
    endpoint_id: int
    matter_device_type_id: int
    def __init__(self, endpoint_id: _Optional[int] = ..., matter_device_type_id: _Optional[int] = ...) -> None: ...

class DeviceDescriptor(_message.Message):
    __slots__ = ("device_id", "matter_device_type_id", "vendor_name", "product_name", "serial_number", "node_label", "vendor_id", "product_id", "hardware_version_string", "software_version_string", "connector_id", "space_id", "ownership", "lifecycle", "owner_user_id", "claimed_at", "endpoints")
